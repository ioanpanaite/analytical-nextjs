              ...
              >
                ...
                >
                  <Box
                    sx={{
                      ...
                      backgroundPosition: 'center',
                      backgroundImage: `url("/images/pages/tailored-programs.jpg")`,
                      backgroundRepeat: 'no-repeat',
                      backgroundSize: 'cover',
                      width: 360,
                      height: 360
                ...
                <Box
                  ...
                  <Box sx={(theme) => ({
                    width: 0,
                    height: 0,
                    borderBottom: { xs: '100vh solid transparent', sm: '700px solid transparent', md: '900px solid transparent' },
            ...
            <Grid item xs={12} sm={6} sx={{ py: '0px !important', px: '0px !important' }}>
              ...
              >
                <Stack spacing={0} useFlexGap>
                  ...
                  >
                    {t("TailoredPrograms Description")}
                  </Typography>
                </Stack>
              </Container>
            </Grid>
