...
export default function NavigatingAscent() {
  const { t } = useTranslation("leadership");

  const data = [
    {
      title: t("The Leadership Ascent"),
      description: t("The Leadership Ascent Description")
    },
    {
      title: t("The Corporate Leader"),
      description: t("The Corporate Leader Description")
    },
    {
      title: t("The Sales Professional"),
      description: t("The Sales Professional Description")
    }
  ]
                ...
                >
                  <Box
                    sx={{
                      ...
                      backgroundImage: `url("/images/pages/navigating.jpg")`,
            ...
            <Grid item xs={12} sm={6} sx={{ py: '0px !important' }}>
              ...
              >
                <Stack spacing={0} useFlexGap>
                  ...
                  >
                    {t("NavigatingAscent Description")}
                  </Typography>
                </Stack>
              </Container>
            </Grid>
