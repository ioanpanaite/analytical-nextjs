...
export default function TailoredTraining() {
  ...
  const data = [
    ...
    {
      title: t("2. Organizational Leadership"),
      description: t("2. Organizational Leadership Description")
    },
    {
      title: t("3. Team Development"),
      description: t("3. Team Development Description")
    },
    {
      title: t("4. Sales and Program Management"),
      description: t("4. Sales and Program Management Description")
    },
    {
      title: t("5. Innovation and Adaptation"),
      description: t("5. Innovation and Adaptation Description")
    },
    {
      title: t("6. Emotional Intelligence"),
      description: t("6. Emotional Intelligence Description")
    }
  ]
                ...
                >
                  <Box
                    sx={{
                      ...
                      backgroundPosition: 'center',
                      backgroundImage: `url("/images/pages/tailored-training.jpg")`,
                      backgroundRepeat: 'no-repeat',
                      backgroundSize: 'cover',
                      width: 360,
                      height: 360
            ...
            <Grid item xs={12} sm={6} sx={{ py: '0px !important' }}>
              ...
              >
                <Stack spacing={0} useFlexGap>
                  ...
                  >
                    {t("TailoredTraining Description")}
                  </Typography>
                </Stack>
              </Container>
            </Grid>
