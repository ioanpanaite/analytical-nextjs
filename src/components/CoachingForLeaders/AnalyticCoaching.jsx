    ...
    <>
                ...
                >
                  <Box
                    sx={{
                      ...
                      backgroundPosition: 'center',
                      backgroundImage: `url("/images/pages/coaching-embracing.jpg")`,
                      backgroundRepeat: 'no-repeat',
                      backgroundSize: 'cover',
                      width: 360,
                      height: 360
      ...
      >
        <Stack spacing={0} useFlexGap>
          ...
          >
            {t("Debunking Leadership Myths Description")}
          </Typography>
        </Stack>
        ...
        >
          ...
          >
            {t("An Integrative Coaching Framework")}
          </Typography>
          <Typography
            component="div"
            variant="div"
          ...
          >
            {t("An Integrative Coaching Framework Description")}
          </Typography>
        </Stack>
      </Container>
    </>
