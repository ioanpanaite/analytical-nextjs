              ...
              >
                ...
                <Box
                  ...
                  <Box sx={(theme) => ({
                    ...
                    borderLeft: { xs: `100vw solid ${theme.palette.primary.white}`, sm: `200px solid ${theme.palette.primary.white}`, md: `440px solid ${theme.palette.primary.white}` }
                  })}
                  />
                </Box>
              </Container>
            ...
            <Grid item xs={12} sm={6} sx={{ py: '0px !important' }}>
              ...
              >
                <Stack spacing={0} useFlexGap>
                  ...
                  >
                    {t("Business Coaching Description")}
                  </Typography>
                </Stack>
              </Container>
            </Grid>
