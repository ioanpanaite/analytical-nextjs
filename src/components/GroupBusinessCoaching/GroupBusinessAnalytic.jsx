...
export default function GroupBusinessAnalytic() {
  const { t } = useTranslation("group-business-coaching");

  const data = [
    {
      title: t("1. Needs Assessment"),
      description: t("1. Needs Assessment Description")
    },
    {
      title: t("2. Customized Coaching Programs"),
      description: t("2. Customized Coaching Programs Description")
    },
    {
      title: t("3. Team Dynamics Analysis"),
      description: t("3. Team Dynamics Analysis Description")
    },
    {
      title: t("4. Group Workshops and Training"),
      description: t("4. Group Workshops and Training Description")
    },
    {
      title: t("5. Ongoing Support"),
      description: t("5. Ongoing Support Description")
    },
    {
      title: t("6. Measurable Outcomes"),
      description: t("6. Measurable Outcomes Description")
    }
  ]
                ...
                >
                  <Box
                    sx={{
                      ...
                      backgroundPosition: 'center',
                      backgroundImage: `url("/images/pages/group-business-analytic.jpg")`,
                      backgroundRepeat: 'no-repeat',
                      backgroundSize: 'cover',
                      width: 360,
                      height: 360
            ...
            <Grid item xs={12} sm={6} sx={{ py: '0px !important', px: '0px !important' }}>
              ...
              >
                <Stack spacing={0} useFlexGap>
                  ...
                  >
                    {t("GroupBusinessAnalytic Description")}
                  </Typography>
                </Stack>
              </Container>
            </Grid>
