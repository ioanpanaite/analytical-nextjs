...
export default function NurturingSeed() {
                ...
                >
                  <Box
                    sx={{
                      ...
                      backgroundImage: `url("/images/pages/nurturing-idea.jpg")`,
        ...
        <Grid item xs={12} sm={6} md={4} sx={{ py: '0px !important', maxHeight: { sm: '100%', md: 'max-content' } }}>
          ...
          >
            <Stack spacing={0} useFlexGap>
              ...
              >
                {t("The Idea Exploration Description")}
              </Typography>
            </Stack>
          </Container>
        </Grid>
        <Grid item xs={12} sm={6} md={4} sx={{ py: '0px !important', maxHeight: { sm: '100%', md: 'max-content' } }}>
          ...
          >
            <Stack spacing={0} useFlexGap>
              ...
              >
                {t("The Quest for Identity Description")}
              </Typography>
            </Stack>
          </Container>
        </Grid>
        <Grid item xs={12} sm={6} md={4} sx={{ py: '0px !important', maxHeight: { sm: '100%', md: 'max-content' } }}>
          ...
          >
            <Stack spacing={0} useFlexGap>
              ...
              >
                {t("The Power of Vision Description")}
              </Typography>
            </Stack>
          </Container>
        </Grid>
