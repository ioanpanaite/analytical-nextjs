...
export default function RoleVisionIncubator() {
  const { t } = useTranslation("vision-incubator");

  const data = [
    {
      title: t("A Creative Odyssey"),
      description: t("A Creative Odyssey Description")
    },
    {
      title: t("Vision Articulation"),
      description: t("Vision Articulation Description")
    },
    {
      title: t("Clarity and Alignment"),
      description: t("Clarity and Alignment Description")
    },
    {
      title: t("The Roadmap to Realization"),
      description: t("The Roadmap to Realization Description")
    }
  ]
                ...
                >
                  <Box
                    sx={{
                      ...
                      backgroundPosition: 'center',
                      backgroundImage: `url("/images/pages/vision-incubator.jpg")`,
                      backgroundRepeat: 'no-repeat',
                      backgroundSize: 'cover',
                      width: 360,
                      height: 360
            ...
            <Grid item xs={12} sm={6} sx={{ py: '0px !important', px: '0px !important' }}>
              ...
              >
                <Stack spacing={0} useFlexGap>
                  ...
                  >
                    {t("RoleVisionIncubator Description")}
                  </Typography>
                </Stack>
              </Container>
            </Grid>
