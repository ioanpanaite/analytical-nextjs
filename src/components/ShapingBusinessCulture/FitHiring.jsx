...
export default function FitHiring() {
  ...
  return (
    <>
      <Box
        sx={(theme) => ({
          width: '100%',
          backgroundImage: `linear-gradient(90deg, ${theme.palette.primary.white} 50%, ${theme.palette.primary.ground} 50%)`,
        })}
      >
        <Box
          id={'FitHiring'}
        ...
        >
          ...
          <Grid container spacing={5} sx={{
            ...
            <Grid item xs={12} sm={6} sx={{ py: '0px !important', px: '0px !important', paddingLeft: { md: '0px !important' } }}>
              <Container
                sx={{
                  display: 'flex',
                  position: 'relative',
