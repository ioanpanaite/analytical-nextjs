...
export default function ShapingCulture() {
  const { t } = useTranslation("shaping-business-culture");

  const data = [
    {
      title: t("1. Enhanced Employee Engagement"),
      description: t("1. Enhanced Employee Engagement Description")
    },
    {
      title: t("2. Higher Productivity"),
      description: t("2. Higher Productivity Description"),
    },
    {
      title: t("3. Improved Retention"),
      description: t("3. Improved Retention Description"),
    },
    {
      title: t("4. Attracting Top Talent"),
      description: t("4. Attracting Top Talent Description"),
    },
    {
      title: t("5. Effective Decision-Making"),
      description: t("5. Effective Decision-Making Description"),
    },
    {
      title: t("6. Adaptability and Innovation"),
      description: t("6. Adaptability and Innovation Description"),
    }
  ]
                ...
                <Box
                  ...
                  <Box
                    sx={{
                      ...
                      backgroundPosition: 'center',
                      backgroundImage: `url("/images/pages/shaping-culture.jpg")`,
                      backgroundRepeat: 'no-repeat',
                      backgroundSize: 'cover',
                      width: 360,
                      height: 360
