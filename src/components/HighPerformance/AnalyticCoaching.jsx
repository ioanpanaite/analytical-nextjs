...
export default function AnalyticCoaching() {
  ...
  const data = [
    {
      title: t("1. Goal Setting and Alignment"),
      description: t("1. Goal Setting and Alignment Description")
    },
    {
      title: t("2. Personalized Development Plans"),
      description: t("2. Personalized Development Plans Description")
    },
    {
      title: t("3. Skill Enhancement"),
      description: t("3. Skill Enhancement Description")
    },
    {
      title: t("4. Leadership Development"),
      description: t("4. Leadership Development Description")
    },
    {
      title: t("5. Performance Feedback"),
      description: t("5. Performance Feedback Description")
    },
    {
      title: t("6. Accountability"),
      description: t("6. Accountability Description")
    },
    {
      title: t("7. Continuous Assessment"),
      description: t("7. Continuous Assessment Description")
    }
  ]
              ...
              >
                ...
                <Box
                  ...
                  <Box sx={(theme) => ({
                    ...
                    borderRight: { xs: `450px solid ${theme.palette.primary.white}`, sm: `200px solid ${theme.palette.primary.white}`, md: `440px solid ${theme.palette.primary.white}` }
                  })}
                  />
                </Box>
              </Container>
